<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ajouter.aspx.cs" Inherits="Brief3_cSharp.ajouter" %>
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form id="form1" runat="server">
        <div id="success" runat="server" class="alert alert-success" role="alert">L'ajout est effectué avec succée</div>
        <div id="fail"  runat="server" class="alert alert-danger" role="alert">L'echec d'ajout</div>
        ...
        <div class="row">
          ...
          <asp:Button id="btn_ajouter" runat="server" class="btn btn-lg btn-primary" OnClick="Button1_Click" Text="Ajouter" />
